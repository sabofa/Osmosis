...
export const BUILTIN_THEMES: ThemePreset[] = [
  {
    ...
    customCss: [
      ':root { --heat-0: #dfe3e9; --heat-1: #b9cbe3; --heat-2: #8db0d6; --heat-3: #5f8fc4; --heat-4: #3b6ea8; --good: #3f7d5a; --bad: #b0473f; }',
      ':root[data-theme="dark"], :root:not([data-theme="light"]) { --heat-0: #2a3038; }',
  ...
  },
  {
    ...
    customCss: [
      ':root { --heat-0: #d8e0d2; --heat-1: #b3d3b8; --heat-2: #86bc93; --heat-3: #57a06d; --heat-4: #2f7a4f; --good: #2f7a4f; --bad: #a6553c; }',
  ...
  },
  {
    ...
    customCss: [
      ':root { --heat-0: #e6d9c8; --heat-1: #f0c29e; --heat-2: #eea16a; --heat-3: #e0753a; --heat-4: #b3411f; --good: #6e7f3c; --bad: #b3411f; }',
  ...
  },
  {
    ...
    customCss: [
      ':root { --heat-0: #e2dbe8; --heat-1: #d5bfe0; --heat-2: #bf98d0; --heat-3: #a06bb6; --heat-4: #7a3e8f; --good: #4c7a6a; --bad: #a8404f; }',
